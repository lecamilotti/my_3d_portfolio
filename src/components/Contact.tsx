...
const Contact: React.FC = () => {
  ...
  return (
    <>
      ...
      <footer className="flex items-center justify-center h-16 mt-5 ">
        <div className="flex items-center space-x-3">
          <a href="mailto:lecamilotti@gmail.com" target="_blank">
            <FaEnvelope className="text-white-600 hover:text-gray-400 transition" />
          </a>
          <a
            href="https://www.linkedin.com/in/leandrocamilotti/"
            target="_blank"
          >
            <FaLinkedinIn className="text-white-600 hover:text-gray-400 transition mr-2" />
          </a>
        </div>
        <p className="text-white">Developed by Leandro Camilotti 2024</p>
      </footer>
    </>
  );
};
